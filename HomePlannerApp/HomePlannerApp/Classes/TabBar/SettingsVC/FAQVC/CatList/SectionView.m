...
- (id)initWithFrame:(CGRect)frame WithTitle: (NSString *) title Section:(NSInteger)sectionNumber delegate: (id <SectionView>) Delegate
{
    ...
    if (self) {
        ...
        self.backgroundColor = [UIColor colorWithRed:255/255.0 green:139.0/255.0 blue:146/255.0 alpha:1.0];
        
        UIImageView *imgLine = [[UIImageView alloc]initWithFrame:CGRectMake(0,self.bounds.size.height-1, self.bounds.size.width,1)];
